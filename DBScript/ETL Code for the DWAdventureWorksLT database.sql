/*************************************************************************************
 This file will flush and fill the sales data mart in the DWAdventureWorksLT2012 database
**************************************************************************************/
...
--********************************************************************--
-- Dimension Tables
SELECT * FROM [DWAdventureWorksLT2012].[dbo].[DimCustomers]; 
SELECT * FROM [DWAdventureWorksLT2012].[dbo].[DimProducts]; 
SELECT * FROM [DWAdventureWorksLT2012].[dbo].[DimDates]; 

-- Fact Tables 
SELECT * FROM [DWAdventureWorksLT2012].[dbo].[FactSales]; 
